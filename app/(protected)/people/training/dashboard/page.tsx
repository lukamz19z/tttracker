...
function statusPillClasses(status: RequirementCheck["status"]) {
  if (status === "current") {
  ...
  const loadData = useCallback(async () => {
    const [
      ...
      supabase
        ...
        .select(
          "id, employee_id, training_type_id, training_name, category, certificate_number, expiry_date, does_not_expire, record_status, superseded_at, revoked_at, sharepoint_web_url, created_at",
        )
