          ...
          <div className="flex flex-col gap-5 xl:flex-row xl:items-start xl:justify-between">
            <div>
              ...
              <p className="mt-2 max-w-3xl text-sm leading-6 text-slate-500">
                Search, filter, maintain and export the complete workforce training register. Add certificates, licences and VOCs while keeping supporting documents linked from SharePoint.
              </p>
            </div>
