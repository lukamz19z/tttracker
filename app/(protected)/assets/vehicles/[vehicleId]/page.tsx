...
export default function VehicleDetailPage() {
  ...
  const [expandedAssetHistoryId, setExpandedAssetHistoryId] = useState<string | null>(
    null,
  );
          ...
          <div className="space-y-5">
            <section className="rounded-2xl border border-slate-200 bg-white p-5 shadow-sm">
              <SectionHeader
                ...
                description="Service and inspection records. Fleet Job service close-outs also appear here."
              />
