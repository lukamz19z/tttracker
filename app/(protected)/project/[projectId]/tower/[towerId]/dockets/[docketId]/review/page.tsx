    ...
    async function load() {
      ...
      try {
        ...
        if (!cancelled) {
          ...
          setAllowedReviewer(Boolean(reviewerAccessRes?.allowed));
          setReviewerName(
            String(
          ...
          <div className="mb-6 rounded-2xl border border-amber-200 bg-amber-50 p-4 text-sm text-amber-900">
            <div className="flex gap-3">
              ...
              <div>
                ...
                <p className="mt-1">
                  Your signed-in TTTracker account is not selected as a BC Daily
                  Docket reviewer for this project. Reviewer access is based on
                  the exact user account selected in Approval Settings, not the
                  user&apos;s website role.
                </p>
              </div>
            </div>
